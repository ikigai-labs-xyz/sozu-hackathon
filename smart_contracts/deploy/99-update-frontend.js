...
const frontendLendingBorrowingAbiFile =
  "../frontend/constants/lending_borrowing_abi.json";
...
const updateAbi = async () => {
  ...
  const abiFile = path.resolve(
    abisDir,
    "contracts_LendingBorrowing_sol_LendingBorrowing.abi"
  );
  const abi = JSON.parse(fs.readFileSync(abiFile, "utf8"));

  fs.writeFileSync(
    frontendLendingBorrowingAbiFile,
